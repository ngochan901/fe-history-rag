      ...
      <div className="relative bg-[#fcf9ee] w-full max-w-md overflow-hidden border border-outline-variant/50 shadow-2xl animate-in fade-in zoom-in duration-300">
        ...
        <div className="p-10 flex flex-col items-center text-center">
          ...
          <p className="font-body text-sm text-on-surface-variant leading-relaxed mb-10">
            Mọi phiên làm việc hiện tại sẽ kết thúc. Bạn sẽ cần định danh lại để tiếp tục truy cập vào hệ thống <span className="text-primary font-bold italic">Sử Việt</span>.
          </p>

          {/* Nút thao tác */}
          <div className="w-full flex flex-col sm:flex-row gap-3 font-mono text-[11px] font-bold tracking-widest">
            <button 
              onClick={onClose}
